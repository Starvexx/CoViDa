...
if __name__ == "__main__":
    ...
    prospect = np.polyfit(days, infected, 4)
...
#    interpolated = []
    ...
    for t in t_new:
        ...
        # fitted.append(prospect[0]*day**4+prospect[1]*day**3+prospect[2]*day**2+prospect[3]*day+prospect[4])
    print(fitted)
    fig = plt.figure(figsize=(10, 10))
    ax1 = fig.add_subplot(311)
    ax2 = fig.add_subplot(312)
    ax3 = fig.add_subplot(313)
    ax1.plot_date(days, infected)
    ax1.plot(timeline, fitted)
#    ax1.plot_date(days, func(days, *popt))
